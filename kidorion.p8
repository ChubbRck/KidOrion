...
paltimer +=1
	 if (btnp(4)) cls() music(-1) state = 1.5
  ...
  oldvelx = p.vel.x
   ...
   if (p.vel.x^2 + p.vel.y^2) > p.maxvel^2 then
   	...
   	p.vel.y = oldvely
			...
			newx = p.x + p.vel.x
			if abs(p.vel.x) < .51 then
			if p.vel.x <= 0 then
			valx = -.51
			elseif p.vel.x > 0 then
			valx = .51
			end
			else
			valx = p.vel.x
			...
			if checkwall(xcheck, p.y) or checkwall(xcheck, p.y+1) or checkwall(xcheck, p.y+4) or checkwall(xcheck,p.y+7) or checkwall(xcheck+7, p.y) or checkwall(xcheck+7, p.y+1) or checkwall(xcheck+7, p.y+4) or checkwall(xcheck+7,p.y+7) then
				p.vel.x *= -1 * p.bounce
				matched = true
				sfx(1)
		...
		applydamage(sqrt(p.vel.x^2 + p.vel.y^2))
			...
			newy = p.y + p.vel.y
			if abs(p.vel.y) < .51 then
			if p.vel.y <= 0 then
			valy = -.51
			elseif p.vel.y > 0 then
			valy = .51
			end
			else
			valy = p.vel.y
			...
			ycheck = p.y+valy
			if checkwall(p.x, ycheck) or checkwall(p.x +1, ycheck) or checkwall(p.x+4, ycheck) or checkwall(p.x+7, ycheck) or checkwall(p.x, ycheck+7) or checkwall(p.x+4, ycheck+7) or checkwall(p.x+7, ycheck+7) then
				matched = true
				p.vel.y *= -1 * p.bounce	
				sfx(1)
...
function _update()
	...
	--	sb.vel.x = cos(rnd(1))*3
	--	sb.vel.y = cos(rnd(1))*3
		sb.vel.x = rnd(8)-4
		sb.vel.y = rnd(8)-4
		srand(rnd(1200))
...
if pt.isbullet then
	...
	if itemtile == 47 or itemtile == 5 then
	storeitem(itemtile,pt.x,pt.y)
	cleartile(pt.x, pt.y)
	sfx(10)
	del (bullets, pt)
...
--local itemtile = mget(flr(x/8),(flr(y+320)/8))
	...
	if (fget(itemtile,6))then -- gas
		...
		sb.vel.x = cos(rnd(1))*2
		sb.vel.y = cos(rnd(1))*2
		sb.val="fuel!"
		sb.col = 3
		-- play sfx
		-- increase var
...
spr(45,flr(112+cam.x),flr(120+cam.y))
end
...
function _draw()
	...
	if state == 1 then
		...
		print("music by mark denardo", 64-42,123,5)
...
--runmessage(intromsg)
	...
	if state ==2.5 then
	 ...
	 if state == 10 then
 		...
 		if g.timer - g.marktimer > 300 then
	 	restart()
	 	end
	 end
	if state == 2 then
...

...
a02323131313131323232323131313f3f3f3f3f3f3f3f3f3f3f3f3f3f3f3f3f3f3f3f3f3f3f3f3f3f3f3f3f3f3f3f3f3f3f3f3f3f3f3f3f3a013131313131313
...
a023231313131313232323232323f3f3131313f3f3f3f3f3f3f3f3f3f3f3f3f3f3f3f3f3f3f3f3f3f3f3f3f3f3f3f3f3f3f3f3f3f3f3f3f3b1f2f2f2b1131313
...
a0232323232323232323232323f3f3f31313131313f3f3f3f3f3f313131313131313131313131313f3f3f3f3f3f3f3f3f3f3f3f3f3f3f3f3b1131313b1131313
...
a0232323232323232323232323f3f3f3131313131313f3f3f3f30013131313131313131313131313131313131313f3f3f3f3f3f3f3f3f3f3b1131313b1131313
...
a0232323232323232323232323f3f3f3131313131313f3f313130013131313131313131313131313131313131313131313f3f3f3f3f3f3f3b1132213b1131313
...
f3f3f3f3f32323232323232323f3f3f313131313131313131313131313131313131313131313131313131313131313131313f3f3f3f3f3f3b113e223b1131313
...

...

...

...
f3f3f3f3f3f3c0b0c0b0f3f3f3f3f3f31313f3f31313131313131313131313f3131313131313131313131313f3f3f313131313131313f3f3a013131313131313
...

...
131313131313131313131313131313a0a013131313231313131313131313131313131313131313131313131313131313131313131313131381f313131313f381
...
131313131313701313131313131313a0a013131313231313131313131313131313131313139013131313131313131313131313131313131381f3131313f3f381
...

...
a013131313f3e0e0e0e0f3231313131313131313131313131313f3f3f3131313131313f3f3f3f3f3f3131313131313131313131313f3f3f3a013131313131313
...
a0131313131313131313131313131313131313131313131313131313f3f3f3f3f3f3f3f3f31313131313131313131313131313131313f3f3a013131313b1b1b1
...
__gff__

__map__

...

...

__sfx__
...
011000000e47610476114760e476104760e65610656106560e656106561065611656116560e1760e17610176111760e27610276112760e27610276112760e27610276112760e27610276112760e2761027611276
...

